...
//            BigDecimal.valueOf(5),BigDecimal.valueOf(30));
    ...
    @RequestMapping(path = "orders/changeStatus/{id}/{status}", method = RequestMethod.POST)
    public void changeOrderStatusById(@RequestBody String status, @RequestBody int id) {
